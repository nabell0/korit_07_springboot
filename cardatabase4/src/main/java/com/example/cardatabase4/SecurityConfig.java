...
public class SecurityConfig {
    ...
    private final AutthEntryPoin exceptionHanler;

    public SecurityConfig(UserDetailsServiceImpl userDetailsService, AuthencationFilter authencationFilter, AutthEntryPoin autthEntryPoin) {
        this.userDetailsService = userDetailsService;
        this.authencationFilter = authencationFilter;
        this.exceptionHanler = autthEntryPoin;
    }
